    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--bg)' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          {/* 测试连接 */}
          <button type="button" className="toolbar-icon-btn" title="测试连接" onClick={() => { console.log('[DEBUG] 测试连接按钮被点击'); setConnectionTestDialogOpen(true) }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          {/* 分享 */}
          <button type="button" className="toolbar-icon-btn" title="分享配置" onClick={() => { console.log('[DEBUG] 分享按钮被点击'); setShareDialogOpen(true) }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          {/* 设置 */}
          <button type="button" className="toolbar-icon-btn" title="高级设置" onClick={() => { console.log('[DEBUG] 高级设置按钮被点击'); setAdvancedSettingsOpen(true) }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
