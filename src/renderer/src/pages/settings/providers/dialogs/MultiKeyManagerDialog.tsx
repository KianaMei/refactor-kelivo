      ...
      >
        ...
        <div style={{ padding: '12px 16px', borderBottom: '1px solid var(--border)', display: 'flex', gap: 16, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <CustomSelect
              value={strategy}
              onChange={(val) => void handleChangeStrategy(val as LoadBalanceStrategy)}
              options={LOAD_BALANCE_STRATEGIES}
            ...
            filteredKeys.map((key, index) => (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                  ...
                  {/* 删除 */}
                  {keyDeleteConfirm.isConfirming(key.id) ? (
                    <div style={{ display: 'flex', gap: 4 }}>
                      <button
                        ...
                        onClick={() => keyDeleteConfirm.confirmDelete(key.id, () => void handleDeleteKey(key.id))}
                      >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      ...
                      <button
                        ...
                        className="toolbar-icon-btn"
                        title="取消"
                        onClick={() => keyDeleteConfirm.cancelConfirm()}
                      >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <button
                      ...
                      title="删除"
                      style={{ color: 'var(--danger)' }}
                      onClick={() => keyDeleteConfirm.startConfirm(key.id)}
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
